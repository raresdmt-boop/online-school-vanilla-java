...
public class BooksService {
    ...
    public List<Books> cartileStudentului(int sID){
        List<Books> studentBooks = new ArrayList<>();
        for(int j=0;j<listaBooks.size();j++){
            Books book = listaBooks.get(j);
